...
const MainText = () => {
  ...
  return (
    <>
      <div className="main-container col-lg-4 col-md-5 col-10 left-animation">
        <div className="d-flex flex-column justify-content-start white-transparent-bg">
          ...
          Hello, I'm Gabriel Cordero, a Full-stack developer with UX / UI skills, specialized in Front-End developement. I believe that makes me          <span className='typing-text'>
