...
const Tags = () => {
  return (
    <div className="d-flex flex-wrap col-lg-4 col-md-8 tag-container left-animation ">
      ...
      <div className="tag text-lightBlack bg-lightGray">NodeJS</div>
      <div className="tag text-clearWhite bg-lightBlack">UX/UI Design</div>
      <div className="tag text-clearWhite bg-mainColor">SASS</div>
      <div className="tag text-clearWhite bg-darkBlue">Vite</div>
      ...
      <div className="tag text-clearWhite bg-darkBlue">SQL</div>
      <div className="tag text-lightBlack bg-lightGray">MySQL</div>
